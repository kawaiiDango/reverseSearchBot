  ...
  answerInlineQuery: {
    ...
    arguments: answers => {
      return {
        ...
        switch_pm_text: answers.switch_pm_text,
        switch_pm_parameter: answers.switch_pm_parameter
...
class AnswerList {
  ...
  constructor(id, opt={}) {
    ...
    this.switch_pm_text = opt.switch_pm_text === undefined ? false : opt.switch_pm_text;
    this.switch_pm_parameter = opt.switch_pm_parameter === undefined ? false : opt.switch_pm_parameter;
    this.list = [];
  }
